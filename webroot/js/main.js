...
$('.banner').on({
    mouseenter: function () {
        ...
        price.html((price.html() * 0.9).toFixed(2));
...
$(document).ready(function () {
    $('#read').text(randomInteger(0, 5));
    var totalRead = $('#total-read').text();
    var read = $('#read').text();
    $('#random-read').text(+totalRead + +read);
    setInterval(function () {
        $('#read').text(randomInteger(0, 5));
        var randomRead = $('#random-read').text();
        var read = $('#read').text();
        $('#random-read').text(+randomRead + +read);
